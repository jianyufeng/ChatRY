 ...
 */
package com.sanbafule.sharelock.view.editText;
...
public class ShareLockClearEditText extends EditText implements View.OnTouchListener , View.OnFocusChangeListener{

	final Drawable mClear = getResources().getDrawable(R.drawable.search_clear);
	/**
	 * @param context
	 */
	public ShareLockClearEditText(Context context) {
		super(context);
	 ...
	 * @param attrs
	 */
	public ShareLockClearEditText(Context context, AttributeSet attrs) {
		super(context, attrs);
		initCCPClearEditTextRef();
	}
	 ...
	 * @param defStyle
	 */
	public ShareLockClearEditText(Context context, AttributeSet attrs, int defStyle) {
