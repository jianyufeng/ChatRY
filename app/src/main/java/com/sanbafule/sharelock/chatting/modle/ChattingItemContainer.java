...
public class ChattingItemContainer extends RelativeLayout {
	...
	public ChattingItemContainer(LayoutInflater inflater, int resource) {
		...
		textViewLayoutParams.setMargins(0, getResources().getDimensionPixelSize(R.dimen.android_width_22), 0,
				getResources().getDimensionPixelSize(R.dimen.android_width_22));
