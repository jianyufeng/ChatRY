...
package com.sanbafule.sharelock.zxing.decode;
...
import com.sanbafule.sharelock.zxing.view.ViewfinderResultPointCallback;
...
public final class CaptureActivityHandler extends Handler {
	...
	public void handleMessage(Message message) {
		...
		case R.id.launch_product_query:
			...
			case 20: // chnggong
				Log.d(TAG, "Got restart preview message");
				activity.success((Result)message.obj);
				break;
			case 21: // shibai
				Log.d(TAG, "Got restart preview message");
				activity.fail((String)message.obj);
				break;
		}
	}
